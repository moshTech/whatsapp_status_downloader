                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          Text("FileManager > whatsapp_status_downloader",
                              style: TextStyle(
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          if (!Directory(
                  "/storage/emulated/0/Video/whatsapp_status_downloader/Videos")
              .existsSync()) {
            Directory(
                    "/storage/emulated/0/Video/whatsapp_status_downloader/Videos")
          ...
          String newFileName =
              "/storage/emulated/0/whatsapp_status_downloader/Videos/VIDEO-$curDate.mp4";
          print(newFileName);
